...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let QRCodeViewController = ScannerViewController()
        ...
        let viewControllerList = [ homeViewController,QRCodeViewController, addViewController,storageViewController,settingViewController ]
